...
const FACTS: { fact: string; from: Provenance; why: string }[] = [
    ...
    { fact: "Buying a sloped tile makes it the park's, not flat", from: "game", why: "ownership and terrain are separate in the game, and this bridge has no levelling call" },
