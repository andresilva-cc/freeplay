...
export class PathRemoveTools {
    @mcpTool({
        ...
        description: [
            ...
            "remove one. An ordinary path laid over a queue unbinds that queue from its ride, and a queue laid",
            "across a route guests were using splits the park in two, because guests cannot walk through a queue.",
