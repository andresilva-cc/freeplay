...
export class MapViewTools {
    @mcpTool({
        ...
        description: [
            ...
            "letter is - `#` track belonging to a ride numbered past z, `Q` queue, `P` footpath,",
            ...
            "that tile buildable. The `legend` in each result explains every character that render",
            "actually used, and no character it did not.",
