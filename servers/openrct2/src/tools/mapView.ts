...
export class MapViewTools {
    @mcpTool({
        ...
        description: [
            ...
            "corridor reads as `UP`: guests walk it and the park can neither pave onto it nor usually buy",
            "it. `P` and `Q` say nothing about the slope beneath them, which is the one thing this map",
