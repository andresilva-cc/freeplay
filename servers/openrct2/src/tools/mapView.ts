...
export class MapViewTools {
    @mcpTool({
        ...
        description: [
            ...
            "the park's land, `^` the park's but sloped, which no typed tool here levels though",
            "`evaluate` reaches the game's own landsetheight, landraise, landlower and landsmooth, `S` the park's",
