...
export class SiteTools {
    @mcpTool({
        ...
        description: [
            ...
            "either way.",
            "`fits` is whether every tile of that footprint is the park's, level, at the ride's height",
            ...
            "`access` is every tile an entrance or exit building could go on for this placement, with",
            ...
            "one face. The list is in the order the tiles ring the footprint and is ordered by nothing",
            "else: it is not sorted, not trimmed, and not marked, and which door to use is yours to pick.",
            "A tile is in it only when it is owned, level, at the ride's own height and carrying nothing",
            "but scenery, and the tile its door opens onto is owned and carries nothing but scenery, a",
            "footpath, or a queue belonging to no ride.",
            ...
            "entrance chains it to the new ride and dead-ends that one tile. Doors carrying a queue that",
            "belongs to another ride are not listed at all, because building there would take that",
            "ride's queue away.",
