...
export class LandTools {
    @mcpTool({
        ...
        description: [
            ...
            "No typed tool levels ground. Buying a sloped tile makes it the park's without flattening it.",
            "build_flat_ride needs level ground; build_path lays flat path only, which is that tool's limit",
            "and not the game's - OpenRCT2 footpaths run up slopes. Levelling is the game's own",
            "landsetheight, landraise, landlower and landsmooth, which `evaluate` reaches.",
