...
export class ClearTools {
    @mcpTool({
        ...
        description: [
            ...
            "names. It clears that rectangle of tiles, both corners included. Those four ARE the ride's",
            "ground: the ride's size does not give the rectangle, and the placement's `x`,`y` is a build",
            "origin inside that ground rather than a corner of it.",
            ...
            "`tilesCleared` is how many tiles actually lost something, counted off the map after the",
            "removals rather than from the size of the rectangle, and `tilesNothingToClear` how many of",
            "them were already bare. `area` in the result is the rectangle actually worked on, and `tilesStillBlocked` what is",
