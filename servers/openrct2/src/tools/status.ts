...
export class StatusTools {
    @mcpTool({
        ...
        description: [
            ...
            "tile itself is not counted, 0 means there is a way round, and `cuts` says the same figure in a",
            "sentence and is there only above 0. `severingComputed` false means that was not worked",
