    ...
    @mcpTool({
        ...
        inputSchema: {
            ...
            properties: {
                ...
                x: { type: "integer", minimum: 0, description: "Tile x of the build origin - the tile you are laying the ride from, and the `x` you asked describe_placement about. The origin ends up inside the footprint but it is NOT its centre and NOT a corner: a 4x4 runs 0..3 from it, a 1x4 runs -2..+1, a 3x3 runs -1..+1. Derive nothing from it — the ground the ride stands on is the `footprint` describe_placement reports for this placement." },
