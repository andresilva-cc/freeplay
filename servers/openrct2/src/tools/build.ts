    ...
    @mcpTool({
        ...
        inputSchema: {
            ...
            properties: {
                ...
                open: { type: "boolean", description: "Open the ride once it is built. Opening one guests cannot yet reach draws complaints and costs park rating, so it is usually worth connecting it first." },
